...
const Portifolio = () => {
    ...
    const works = [{
        ...
        title: 'CSN - Compania Siderúrgica Nacional', image: CSNBanner.src, icon: CSNIcon.src
    }, {
        ...
        title: '', image: VRSystemBanner.src, icon: VRSystemIcon.src
    }, {
        ...
        title: 'GP Formula 1 - Brasil', image: GpBanner.src, icon: GpIcon.src
    }, {
        ...
        title: 'Rádio Itaitiaia', image: ItatiaiaBanner.src, icon: ItatiaiaIcon.src
    }, {
        ...
        title: 'Ponte Preta', image: PontePretaBanner.src, icon: PontePretaIcon.src
    }, {
        ...
        title: 'Neosaldina', image: NeosaldinaBanner.src, icon: NeosaldinaIcon.src
    }, {
        ...
        title: 'Instituto Unibanco', image: InstitutoUnibancoBanner.src, icon: InstitutoUnibancoIcon.src
    }, {
        ...
        title: 'Icatu Seguros', image: IcatuBanner.src, icon: IcatuIcon.src
    }, {
        ...
        title: 'Itaú', image: ItauBanner.src, imageAlign: 'right', icon: ItauIcon.src
    }, {
        ...
        title: 'Midway Financeira', image: MidwayBanner.src, imageAlign: 'left', icon: MidwayIcon.src
    }, {
        ...
        title: 'banQi - Casas Bahia', image: banQiBanner.src, imageAlign: 'right', icon: banQiIcon.src
    }]
